...
CHECKPOINT_DIR = './checkpoints/checkpoint04A/'
LOG_DIR = './logs'
...
for index in min_id:
    ...
    test_preds_ls.append(test_model.predict_generator(test_generator(df=GTbbox_test_df, datagen = None), # train_datagen), 
...
if full:
    subm_name = '../sub/subm_full_convsq_noaug_resnet_9A.csv'
else:
    subm_name = '../sub/subm_part_convsq_noaug_resnet_9A.csv'
