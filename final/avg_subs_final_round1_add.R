...
id = grep("image", subm_final$image)
subm_final[id]$image = paste0("test_stg2/",subm_final[id]$image)
...
# Round #1 Sub
write.csv(subm_final, paste0("sub/final-round1-input-pseudo-add_stg2.csv"), row.names = F)
