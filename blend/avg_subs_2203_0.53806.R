...
for (var in cols) subm_01[[var]] = (subm_01A[[var]]*.25) + (subm_01B[[var]]*.25) + (subm_01C[[var]]*.5)
subm_01A
subm_01B
subm_01C
subm_01
...
setwd("~/Dropbox/fish/sub")
  write.csv(subm_05, "avg_(boostLAG)(resnet_box_over_0.7_full)_70_30_(avg_2_best_0303_&50_50_pseudo)_2203B.csv",  row.names = F)
