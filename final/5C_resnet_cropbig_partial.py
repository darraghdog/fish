...
CHECKPOINT_DIR = './checkpoints/checkpoint05C/'
LOG_DIR = './logs'
...
file_name = 'GTbbox_big_df.pickle'
...
allFiles = [f for f in all_files if 'FISH540.' in f]
frame = pd.DataFrame()
list_ = []
...
if full:
    subm_name = '../sub/subm_full_convbig_resnet_5C.csv'
else:
    subm_name = '../sub/subm_part_convbig_resnet_5C.csv'
