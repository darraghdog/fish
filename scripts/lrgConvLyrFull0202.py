...
path = "data/fish/"
batch_size=64
batches = get_batches(path+'train-all', batch_size=batch_size)
...
trn = get_data(path+'train-all', (360,640))
...
subm_name = path+'results/subm_bb_conv_lrgfull0202B.csv.gz'
#pred_name = path+'results/pred_bb_conv_lrg0202B.csv.gz'
