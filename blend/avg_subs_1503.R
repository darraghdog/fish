library(data.table)
rm(list=ls())
subm_01 <- fread("~/Dropbox/fish/sub/subm_part_resnet_cut0.5_20170315.csv")
...
write.csv(subm_05, "avg_(resnet_cut_yolo_over_0.5)_50_50_(avg_2_best_50_50_morebags_0303)_1503.csv",  row.names = F)
# 0.625
