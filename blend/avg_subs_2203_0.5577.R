...
subm_01B <- fread("~/Dropbox/fish/sub/subm_full_resnet_box_cut0.7_20170322.csv")
subm_01 = subm_01A
...
setwd("~/Dropbox/fish/sub")
  write.csv(subm_05, "avg_(boostLAG)(resnet_box_over_0.7_full)_70_30_(avg_2_best_0303_&50_50_pseudo)_2203.csv",  row.names = F)
