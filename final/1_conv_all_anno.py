...
gc.collect()
conv_val_feat = load_array(path+'results/1_conv_val_big_feat.dat')
conv_trn_feat = load_array(path+'results/1_conv_trn_big_feat.dat') 
conv_test_feat = load_array(path+'results/1_conv_test_big_feat.dat')
