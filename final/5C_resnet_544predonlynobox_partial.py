...
CHECKPOINT_DIR = './checkpoints/checkpoint03C/'
LOG_DIR = './logs'
...
allFiles = [f for f in all_files if 'FISH544.' in f] # comp4_det_test_FISH.txt
frame = pd.DataFrame()
list_ = []
...
if full:
    subm_name = '../sub/subm_full_conv544_resnet_5C.csv'
else:
    subm_name = '../sub/subm_part_conv544_resnet_5C.csv'
