...
# Zip the folder for rcnn
make_archive(
  'annos_xml', 
  'zip',           # the archive format - or tar, bztar, gztar 
  root_dir=os.path.join(path, anno_path, 'annosxml/'),   # root for archive - current working dir if None
  base_dir=os.path.join(path, anno_path, 'annosxml/'))   # start archiving from here - cwd if None too