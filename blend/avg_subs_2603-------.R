...
subm_01E <- fread("subm_full_resnet_revise_cut0.7_20170326.csv") # Yolo 544 with relabel target
...
# Boost the "NoF" scores. (This adds about 0.005 to score - not huge)
subm_05[NoF>0.5][["NoF"]] = 10
subm_05 = data.frame(subm_05)
subm_05[,2:9] = subm_05[,2:9]/rowSums(data.frame(subm_05[,2:9]))
subm_05 = data.table(subm_05)
...
setwd("~/Dropbox/fish/sub")
  write.csv(subm_06, "similar_groups_avg_(rfcn)(yolo544relabel&yolo418)(boostNoFLAG)(resnet_box_over_0.7_full)_70_30_(avg_2_best)_2603A.csv",  row.names = F)
