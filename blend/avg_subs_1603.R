library(data.table)
rm(list=ls())
subm_01 <- fread("~/Dropbox/fish/sub/subm_full_resnet_cut0.6_20170316.csv")
...
write.csv(subm_05, "avg_(resnet_cut_yolo_over_0.6_full)_70_30_(avg_2_best_50_50_morebags_0303)_1603.csv",  row.names = F)
# 0.625
