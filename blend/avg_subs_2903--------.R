...
setwd("~/Dropbox/fish/sub")
  write.csv(subm_06, "similar_groups_avg_(fullwithyolo)(yolo544&yolo418)(boostNoF,LAG,OTHER)(resnet_box_over_0.7_full)_70_30_(avg_2_best)_2903.csv",  row.names = F)
